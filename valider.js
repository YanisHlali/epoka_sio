...
async function validerMission(idMission) {
  const res = await fetch(`https://new-epoka-c76fz5tv0-yanishlali.vercel.app/api/missions/${idMission}/valider`);
...
export const getStaticProps = async () => {
  const res = await fetch('https://new-epoka-c76fz5tv0-yanishlali.vercel.app/api/missions/valider');
  const data = await res.json();
